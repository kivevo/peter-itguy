      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-14 sm:mb-18">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-heading text-foreground tracking-tight">
            How Peter Helps You: <br className="hidden sm:inline" />
            <span className="text-gradient-teal">From Computer Headaches to Fast Peace of Mind</span>
          </h2>
          <p className="text-base sm:text-lg text-muted-foreground">
            A simple, dependable 4-step workflow developed across 30+ dealership branches, hotels, and retail shops.
          </p>
        </div>
        ...
        <div className="mt-12 p-6 rounded-2xl bg-teal-500/10 border border-teal-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="space-y-1 text-center sm:text-left">
            <h4 className="font-heading font-bold text-base text-foreground">
              Facing an active computer crash or Wi-Fi breakdown right now?
            </h4>
            <p className="text-xs text-muted-foreground">
              Skip slow ticketing queues — chat directly with Peter on WhatsApp for immediate help.
            </p>
          </div>
          <a
            href={getWhatsAppUrl("EMERGENCY: My computer / network is down right now and I need fast help.")}
            target="_blank"
          ...
          >
            ...
            <span>Get Emergency Help on WhatsApp</span>
          </a>
        </div>
      </div>
    </section>
